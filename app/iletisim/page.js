  ...
  return (
    <section className="pt-28 pb-20 container mx-auto max-w-xl px-4">
      ...
      <form
        ...
        className="space-y-6 bg-card dark:bg-accent p-8 rounded-2xl shadow-xl border border-border dark:border-cta-active"
      >
        <input
          type="text"
          name="name"
        ...
        <button
          type="submit"
          className="button-whatsapp flex items-center justify-center w-full gap-2"
        >
          <svg
